...
7. (Excel) Realice un gráfico para cada una de las variables categóricas en donde se
 vea el porcentaje de personas morosa por cada clase. Analice los resultados.
```{r}
...
repositorio https://github.com/Cristhian892/Examen-II-virtual.git
nota: se me olvido hacer los commit, los hice cuando termine hasta el punto 8 por estan segudos, el punto 10 cuando realice los commit de subida del 2-8 no lo e realio
...
*https://www-spsanderson-com.translate.goog/steveondata/posts/2024-12-03/?_x_tr_sl=en&_x_tr_tl=es&_x_tr_hl=es&_x_tr_pto=tc
